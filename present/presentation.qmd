...
> **Bottom Line for Sales:** Blended models flag churn as 'Decline', leading to unnecessary volume discounts.
...
ggplot() +
    ...
    annotate("label", x = 0, y = spike_height * 0.5, label = percent(prop_churn, accuracy = 1), color = "gray15", fill = "white", fontface = "bold", size = 4.5, label.size = 0, label.padding = unit(0.3, "lines")) +
    annotate("label", x = last_year_val * 0.8, y = max_dens * 0.2, label = percent(prop_decline, accuracy = 1), color = "gray15", fill = "white", fontface = "bold", size = 4.5, label.size = 0, label.padding = unit(0.3, "lines")) +
    annotate("label", x = last_year_val, y = max_dens * 0.4, label = percent(prop_stable, accuracy = 1), color = "gray15", fill = "white", fontface = "bold", size = 4.5, label.size = 0, label.padding = unit(0.3, "lines")) +
    annotate("label", x = last_year_val * 1.25, y = max_dens * 0.2, label = percent(prop_growth, accuracy = 1), color = "gray15", fill = "white", fontface = "bold", size = 4.5, label.size = 0, label.padding = unit(0.3, "lines")) +
